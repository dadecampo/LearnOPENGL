...
int main()
{
	...
	// ------------------------------------
	Shader lightingShader("Lighting\\MultipleLights\\Ex1\\colors_vs.glsl", "Lighting\\MultipleLights\\Ex1\\colors_fs.glsl");
	Shader lightCubeShader("Lighting\\MultipleLights\\Ex1\\light_cube_vs.glsl", "Lighting\\MultipleLights\\Ex1\\light_cube_fs.glsl");
	...
	std::string specular = "//Resources//container2_specular.png";
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// render
		// ------
		glClearColor(0.85f, 0.66f, 0.4f, 1.0f);
